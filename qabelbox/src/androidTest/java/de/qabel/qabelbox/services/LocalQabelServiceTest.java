...
public class LocalQabelServiceTest extends ServiceTestCase<LocalQabelServiceTester> {
    ...
    public void testAddContact() throws QblStorageNameConflict {
        mService.addContact(contact);
        assertTrue(mService.getContacts(identity).getContacts().contains(contact));
    }

    public void testAddDuplicateContact() throws QblStorageNameConflict {
        try {
            mService.addContact(contact);
            mService.addContact(contact);
    ...
    public void testDeleteContact() throws QblStorageNameConflict {
        mService.addContact(contact);
        assertTrue(mService.getContacts(identity).getContacts().contains(contact));
    ...
    public void testModifyContact() throws QblStorageNameConflict {
        mService.addContact(contact);
    ...
    public void testGetAllContacts() throws QblStorageNameConflict {
        mService.addContact(contact);
    ...
    public void testSendAndReceiveDropMessage() throws QblDropPayloadSizeException, URISyntaxException, QblDropInvalidURL, InterruptedException, QblStorageNameConflict {
