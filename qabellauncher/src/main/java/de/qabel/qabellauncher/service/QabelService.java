...
public class QabelService extends Service {
    ...
    public void onCreate() {
         ...
         *  local resources
         */
        if (QabelLauncherApplication.isResourceActorInitialized()) {
            initServiceResources();
        } else {
    ...
    private void initServiceResources() {
        ...
        dropActor = new DropActor(QabelLauncherApplication.getResourceActor(), emitter);
        ...
        moduleManager = new ModuleManager(emitter, QabelLauncherApplication.getResourceActor());
        try {
