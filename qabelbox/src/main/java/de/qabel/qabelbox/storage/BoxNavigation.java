...
public interface BoxNavigation {
	...
	BoxFile upload(String name, InputStream content, @Nullable TransferManager.BoxTransferListener boxTransferListener) throws QblStorageException, QblStorageNameConflict;
    ...
    void attachExternal(BoxExternalReference boxExternalReference) throws QblStorageNameConflict, QblStorageException;
    ...
    BoxFolder createFolder(String name) throws QblStorageNameConflict, QblStorageException;

    BoxFile rename(BoxFile file, String name) throws QblStorageNameConflict, QblStorageException;

    BoxFolder rename(BoxFolder folder, String name) throws QblStorageNameConflict, QblStorageException;

    BoxExternalReference rename(BoxExternalReference external, String name) throws QblStorageNameConflict, QblStorageException;
